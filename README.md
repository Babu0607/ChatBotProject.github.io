...
* **Code Documentation:** I have added extensive comments throughout the project. Please ensure any new changes include clear documentation as well.
* **Knowledge Base Integration:** Added the `.json` file containing the bot's questions and fully integrated it into the core engine.
